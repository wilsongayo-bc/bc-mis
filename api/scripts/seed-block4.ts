...
const scheduleData = [
  { code: 'GEC 1', description: 'UNDERSTANDING THE SELF', units: 3, startTime: '13:00', endTime: '14:30', days: 'MONDAY,TUESDAY', room: 'ROOM 8', instructor: 'NISHELL S. AMPONG' },
  { code: 'GEC 2', description: 'READINGS IN PHILIPPINE HISTORY', units: 3, startTime: '14:30', endTime: '16:00', days: 'WEDNESDAY,THURSDAY', room: 'ROOM 8', instructor: 'NISHELL S. AMPONG' },
  { code: 'GEC 3', description: 'MATHEMATICS IN THE MODERN WORLD', units: 3, startTime: '13:00', endTime: '14:30', days: 'WEDNESDAY,THURSDAY', room: 'ROOM 8', instructor: 'JUNEL C. BUTLIG' },
  { code: 'GEC 4', description: 'SCIENCE, TECHNOLOGY AND SOCIETY', units: 3, startTime: '10:30', endTime: '12:00', days: 'MONDAY,TUESDAY', room: 'ROOM 8', instructor: 'SHERIEHANE A. LAMBUNAO' },
  { code: 'GEC 5', description: 'PURPOSIVE COMMUNICATION', units: 3, startTime: '14:30', endTime: '16:00', days: 'MONDAY,TUESDAY', room: 'ROOM 8', instructor: 'SARAH B. MAUSISA' },
  { code: 'GEC 6', description: 'ART APPRECIATION', units: 3, startTime: '09:00', endTime: '10:30', days: 'WEDNESDAY,THURSDAY', room: 'ROOM 8', instructor: 'MAUREEN ALEXANDRA E. TEMARIO' },
  { code: 'GEC 7', description: 'LIFE AND WORKS OF RIZAL', units: 3, startTime: '09:00', endTime: '10:30', days: 'MONDAY,TUESDAY', room: 'ROOM 8', instructor: 'NISHELL S. AMPONG' },
  { code: 'NSTP 1', description: 'LITERACY TRAINING SERVICE', units: 3, startTime: '08:00', endTime: '11:00', days: 'FRIDAY', room: 'ROOM 8', instructor: 'JUNEL C. BUTLIG' },
  { code: 'PATHFIT 1', description: 'MOVEMENT COMPETENCY TRAINING', units: 2, startTime: '16:00', endTime: '17:00', days: 'MONDAY,TUESDAY', room: 'ROOM 8', instructor: 'MAUREEN ALEXANDRA E. TEMARIO' }
];
...
async function seed() {
  ...
  // 3. Ensure Section BLOCK 4 exists
  const sectionRepo = AppDataSource.getRepository(CourseSection);
  let section = await sectionRepo.findOne({ where: { sectionName: 'BLOCK 4', courseId: course.id } });
  if (!section) {
    ...
    console.log('Created BLOCK 4 section');
  } else {
    console.log('BLOCK 4 section already exists');
  }
